...
const int16_t zetas[128] = {
  17, 1729, 2580, 3289, 2642, 630, 1897, 848, 1062, 1919, 193, 797, 2786, 
...
int main()
{
  ...
  printf("The coefficient of a is: \n");
  for(int i =0;i<256;i++){
    printf("%d, ",a[i]);
  }
  ...
  printf("The coefficient of b is: \n");
  for(int i =0;i<256;i++){
    printf("%d, ",b[i]);
  }
  printf("\n");
  ...
  printf("After PWM computation, the coefficient in NTT domain is: \n");
  for(int i =0;i<256;i++){
    if((r[i]*3303)%3329<0)
      printf("%d, ",(r[i]*3303)%3329+3329);
    else
